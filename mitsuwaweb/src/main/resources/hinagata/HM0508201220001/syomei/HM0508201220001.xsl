		...
		<HTML>
          ...
          IMG{ vertical-align: -2px; }
			...
			<BODY>
				...
				<TABLE width="100%">
					<thead style="display: table-header-group;" id="TeishutsuBangoHeader">
						<th style="font-weight:lighter;text-align:left;"><span id="TeishutsuBango"></span><br/>　</th>
					</thead>
					<tbody>
						<tr><td>
							<div id="QRCodeTable">
								<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
									<tr>
										<td VALIGN="TOP"><IMG id="QRCode" align="left" hspace="0" BORDER="0" style="width:10.58mm; height:10.58mm; display:none;" /></td>
									</tr>
									<tr>
										<td><span style="height:35mm"/></td>
									</tr>
								</TABLE>
							</div>
							<CENTER>
