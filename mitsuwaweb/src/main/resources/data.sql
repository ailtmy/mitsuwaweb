...
INSERT INTO customer(dtype, name, kana, birthday)
VALUES
('Person','田中一郎', 'タナカイチロウ', '1970-01-01'),
('Company','株式会社法人', 'カ）ホウジン', '1964-11-11'),
('Person','佐藤二郎', 'サトウジロウ', '1953-06-03'),
('Company','合同会社あいうえ', 'ドウ）アイウエ', '2014-05-12'),
('Person','山田三郎', 'ヤマダサブロウ', '1992-05-01'),
('Company','有限会社ゆうげん', 'ユ）ユウゲン', '1934-09-21');
