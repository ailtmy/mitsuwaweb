...
<xsl:output method="html"/>
	...
	<xsl:variable name="移行区分">
		<xsl:choose>
			<xsl:when test="/登記申請書/申請情報/テンプレートバージョン&gt;=1">
	...
	<xsl:template match="登記申請書">
		<HTML>
          ...
          IMG{ vertical-align: -2px; }
			...
			<BODY>
				<!-- 2018-07-05 修正 LD10-21-180001 -->
				<TABLE width="100%">
					<thead id="TeishutsuBangoHeader" style="display: table-header-group;">
						<th style="font-weight:lighter;text-align:left;">
              <span id="TeishutsuBango"/>
              <br/>　</th>
					</thead>
					<tbody>
						<tr>
              <td>
							<div id="QRCodeTable">
								<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
									<tr>
										<td VALIGN="TOP">
                        <IMG BORDER="0" align="left" hspace="0" id="QRCode" style="width:10.58mm; height:10.58mm; display:none;"/>
                      </td>
									</tr>
									<tr>
										<td>
                        <span style="height:35mm"/>
                      </td>
									</tr>
								</TABLE>
							</div>
	...
	<xsl:template match="申請書タイトル">
		...
		<xsl:param name="手続様式名称">
      <xsl:value-of select="/登記申請書/申請情報/手続様式名称"/>
    </xsl:param>
		<xsl:if test="not($補正有無)">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%" cellspacing="0">
				<TR>
					...
					<!-- 2018-07-05 修正 LD10-21-180001 -->
					<xsl:if test="/登記申請書/申請情報/手続ID='HM0508102320001'">
						<TD ALIGN="CENTER">
							<H2>
					...
					<xsl:if test="/登記申請書/申請情報/手続ID='HM0508250110001' or /登記申請書/申請情報/手続ID='HM0508250120001'">
						<TD ALIGN="CENTER">
							<H2>
								信託目録記録申請書
							</H2>
					...
					<xsl:if test="not(/登記申請書/申請情報/手続ID='HM0508102320001' or /登記申請書/申請情報/手続ID='HM0508250110001' or /登記申請書/申請情報/手続ID='HM0508250120001')">
						<TD ALIGN="CENTER">
							<H2>
								<xsl:apply-templates/>
							</H2>
		...
		<xsl:if test="not(.='')">
			<xsl:choose>
				<xsl:when test="count(./添付情報)=0 and count(./会社法人等番号付添付情報)=0">
					<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
						<TR>
							<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="25%">添付情報</TD>
				...
				<xsl:when test="count(./添付情報)&gt;0 and not(./添付情報='')">
					<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
						<TR>
							...
							<TD ALIGN="LEFT" WIDTH="75%">
                <SPAN>
                  <xsl:apply-templates select="./添付情報"/>
                </SPAN>
              </TD>
						</TR>
	...
	<xsl:template match="住民票コード情報">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="25%">住民票コード情報</TD>
					<TD ALIGN="LEFT" WIDTH="75%">
            <SPAN>
              <xsl:call-template name="print-kanji-image"/>
            </SPAN>
	...
	<xsl:template match="登記完了証の交付方法">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="25%">登記完了証の交付方法</TD>
					<TD ALIGN="LEFT" WIDTH="75%">
            <SPAN>
              <xsl:call-template name="print-kanji-image"/>
            </SPAN>
	...
	<xsl:template match="土地の表示">
        ...
        <!-- 2010-12-16 修正 EOL -->
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%">　土地の表示</TD>
				</TR>
			</TABLE>
			<xsl:apply-templates/>
		</xsl:if>
	...
	<xsl:template match="土地の表示/冠記">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" COLSPAN="2" WIDTH="30%">　　<xsl:apply-templates/>
          </TD>
				</TR>
			</TABLE>
		</xsl:if>
    ...
    <xsl:if test="not(./主登記の順位番号='') or not(./同順位付記情報='')">
	    <xsl:if test="not(./主登記の順位番号='')">
        <xsl:value-of select="./主登記の順位番号"/>番</xsl:if>
	    <xsl:if test="not(./同順位付記情報='')">
        <xsl:value-of select="./同順位付記情報"/>
      </xsl:if>
	    <br/>
	  </xsl:if>
	</xsl:template>
	...
	<xsl:template match="信託目録の表示/表示内容">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="TOP" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="30%">　信託目録の表示</TD>
					<TD ALIGN="LEFT" WIDTH="70%">
						<SPAN>
              <xsl:call-template name="print-kanji-image"/>
            </SPAN>
	...
	<xsl:template match="建物の表示">
        ...
        <!-- 2010-12-16 修正 EOL -->
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="100%">　建物の表示（主である建物の表示）</TD>
				</TR>
			</TABLE>
			<xsl:apply-templates/>
		</xsl:if>
	...
	<xsl:template match="建物の表示/冠記">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" WIDTH="100%">　　<xsl:apply-templates/>
          </TD>
				</TR>
			</TABLE>
		</xsl:if>
	...
	<xsl:template match="附属建物の表示欄">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" CELLPADDING="1" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" COLSPAN="2" VALIGN="TOP" WIDTH="30%">　附属建物の表示</TD>
				</TR>
				<xsl:apply-templates/>
			</TABLE>
		</xsl:if>
	...
	<xsl:template match="一棟の建物の表示">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="100%">　一棟の建物の表示</TD>
				</TR>
			</TABLE>
			<xsl:apply-templates/>
		</xsl:if>
	...
	<xsl:template match="専有部分の建物の表示">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="100%">　専有部分の建物の表示</TD>
				</TR>
			</TABLE>
			<xsl:apply-templates/>
		</xsl:if>
	...
	<xsl:template match="敷地権の表示欄">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" CELLPADDING="1" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" COLSPAN="2" VALIGN="TOP" WIDTH="30%">　敷地権の表示</TD>
				</TR>
				<xsl:apply-templates/>
			</TABLE>
		</xsl:if>
	...
	<xsl:template match="共同担保">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="100%">　共同担保</TD>
				</TR>
			</TABLE>
			<xsl:apply-templates/>
		</xsl:if>
	...
	<xsl:template match="他管轄物件">
      ...
      <xsl:number count="申請書情報/申請物件情報/申請物件" format="1" level="any"/>
    </xsl:variable>
		<!-- 2015-08-25 修正 CO15-G1-9001 -->
		<xsl:variable name="HOSEIMOTO_REP">
      <xsl:number count="補正元申請書情報/申請物件情報/申請物件" format="1" level="any"/>
    </xsl:variable>
		<!-- 2015-08-25 修正 EOL -->
		<xsl:variable name="Vcnt">
      <xsl:number format="1"/>
    </xsl:variable>
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
	...
	<xsl:template match="他管轄土地の表示/他管轄冠記">
		...
		<!-- <xsl:if test="not(.='')">-->
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<!--<xsl:if test="(.='前登記の表示')">-->
					<TR>
						<TD ALIGN="LEFT" COLSPAN="2" WIDTH="30%">　管轄外の物件</TD>
					</TR>
				<!--</xsl:if>-->
                <xsl:if test="not(.='')">
				<TR>
	...
	<xsl:template match="対象受付番号">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%" cellspacing="0">
				...
				<TR ALIGN="LEFT"/>
				<TR ALIGN="LEFT">
					<TD COLSPAN="2" VALIGN="TOP" WIDTH="25%">上記の登記の申請について，次のとおり補正する。</TD>
				</TR>
			</TABLE>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="課税情報">
		<xsl:if test="not(./補正納付額='')">
			<TABLE ALIGN="CENTER" BORDER="1" RULES="NONE" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="25%">登録免許税の追加納付</TD>
					<TD ALIGN="LEFT" WIDTH="75%">
            <xsl:apply-templates/>
          </TD>
				</TR>
	...
	<xsl:if test="count(/登記申請書/補正元申請書情報)=0">
		<xsl:if test="not(./名義人情報/氏='')">
			<TABLE ALIGN="CENTER" BORDER="0" RULES="NONE" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="25%">　補正人</TD>
					<TD ALIGN="LEFT" WIDTH="75%">
              <xsl:apply-templates/>
            </TD>
				</TR>
	...
	<xsl:if test="count(/登記申請書/補正元申請書情報)=0">
		<xsl:if test="not(./名義人情報/氏='')">
			<TABLE ALIGN="CENTER" BORDER="0" RULES="NONE" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="25%">　代理人</TD>
					<TD ALIGN="LEFT" WIDTH="75%">
              <xsl:apply-templates/>
            </TD>
				</TR>
	...
	<xsl:template match="補正事項">
		<xsl:if test="not(.='')">
			...
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR ALIGN="LEFT">
					<TD VALIGN="TOP" WIDTH="25%">補正事項</TD>
					<TD WIDTH="75%">
						<SPAN>
              <xsl:call-template name="print-kanji-image"/>
            </SPAN>
	...
	<xsl:template match="補正申請/連絡事項">
		<xsl:if test="not(.='')">
			...
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR ALIGN="LEFT">
					<TD VALIGN="TOP" WIDTH="25%">連絡事項</TD>
					<TD WIDTH="75%">
						<SPAN>
							<xsl:call-template name="print-kanji-image"/>
						</SPAN>
	...
	<xsl:template match="委任状">
		<xsl:if test="not(/登記申請書/制御情報/委任状有無='')">
			...
			<TABLE ALIGN="CENTER" BORDER="0" RULES="NONE" WIDTH="100%" cellspacing="0">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%">　代理人</TD>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates mode="表示" select="/登記申請書/申請書情報/申請手続き情報/代理人"/>
					</TD>
				</TR>
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%"/>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates mode="表示" select="/登記申請書/申請書情報/申請手続き情報/申請人兼義務者代理人"/>
					</TD>
				</TR>
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%"/>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates mode="表示" select="/登記申請書/申請書情報/申請手続き情報/権利者代理人"/>
					</TD>
				</TR>
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%"/>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates mode="表示" select="/登記申請書/申請書情報/申請手続き情報/義務者代理人"/>
					</TD>
				</TR>
				<TR>
          ...
          <TD ALIGN="LEFT" WIDTH="75%">　</TD>
				...
				<TR>
					<TD ALIGN="LEFT" COLSPAN="2" WIDTH="20%">上記の者を代理人と定め，次の事項を委任します。</TD>
				</TR>
			</TABLE>
			<xsl:apply-templates/>
		</xsl:if>
	...
	<xsl:template match="委任者">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" RULES="NONE" WIDTH="100%" cellspacing="0">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%">　委任者</TD>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates/>
					</TD>
				</TR>
	...
	<xsl:template match="補正元申請書情報/申請書タイトル">
		<xsl:variable name="手続様式名称">
      <xsl:value-of select="/登記申請書/補正元申請書情報/手続様式名称"/>
    </xsl:variable>
		<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%" cellspacing="0">
			<TR>
				<!-- 2018-07-05 修正 LD10-21-180001 -->
		...
		<xsl:if test="count(/登記申請書/補正元委任状/委任年月日)&gt;0 and not(/登記申請書/補正元委任状/委任年月日='')">
			...
			<TABLE ALIGN="CENTER" BORDER="0" RULES="NONE" WIDTH="100%" cellspacing="0">
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%">　代理人</TD>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates mode="表示" select="/登記申請書/補正元申請書情報/申請手続き情報/代理人"/>
					</TD>
				</TR>
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%"/>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates mode="表示" select="/登記申請書/補正元申請書情報/申請手続き情報/申請人兼義務者代理人"/>
					</TD>
				</TR>
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%"/>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates mode="表示" select="/登記申請書/補正元申請書情報/申請手続き情報/権利者代理人"/>
					</TD>
				</TR>
				<TR>
					<TD ALIGN="LEFT" VALIGN="TOP" WIDTH="20%"/>
					<TD ALIGN="LEFT" WIDTH="75%">
						<xsl:apply-templates mode="表示" select="/登記申請書/補正元申請書情報/申請手続き情報/義務者代理人"/>
					</TD>
				</TR>
				<TR>
          <TD ALIGN="LEFT" WIDTH="20%">　</TD>
	...
	<xsl:if test="not(./元号='') or not(./年='') or not(./月='') or not(./日='')">
		<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
			<TR>
				<TD ALIGN="LEFT">
					<xsl:if test="not(./元号='')">
              <xsl:value-of select="./元号"/>
            </xsl:if>
					<xsl:if test="not(./年='')">
              <xsl:value-of select="./年"/>年</xsl:if>
					<xsl:if test="not(./月='')">
              <xsl:value-of select="./月"/>月</xsl:if>
					<xsl:if test="not(./日='')">
              <xsl:value-of select="./日"/>日</xsl:if>
					受付
				</TD>
			</TR>
		</TABLE>
	...
	<xsl:template match="原因">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="特約">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="売買代金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="契約費用">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="期間">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="目的">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="存続期間">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="地代">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="支払時期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="範囲">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="移転持分">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<!--2014-01-06 CO13-G1-0025 修正-->
	<xsl:template match="移転すべき登記">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<!--2014-01-06 CO13-G1-0025 EOL-->
	<xsl:template match="小作料">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="代位原因">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="債権額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="工事費用予算額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="代位弁済額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="損害金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="存続期間">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="債権価格">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="極度額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="債権の範囲">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="確定期日">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="担保限度額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="施業方法">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="社債の総額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="社債の利率">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="社債分割発行回数">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="社債の利率の最高限度">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="社債発行金額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="譲渡額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="弁済額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="競売代価">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="延滞利息">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="分割後の債権">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="更正後の順位">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="質入債権">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="優先の定め">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="賃料">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="管理人">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="嘱託条項">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="延滞税の額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="内容">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="採石料">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息発生期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="禁止事項">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="地役権の存続する部分">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="登記原因">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="登記原因及びその日付">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="権利消滅の定め">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="地上権消滅の定め">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="対価">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="譲渡債権額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="変更後の順位">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="遅延損害金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="元本確定期日">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="債権の条件">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="元本の弁済期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="元本の支払場所">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息の弁済期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息の支払場所">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="権利消滅事項特約">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="賃借権の消滅事項の定め">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="順位譲渡の原因">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="順位放棄の原因">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="回復の原因">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="地代及び支払期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="その他事項">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="申請事項/建物の表示">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="申請手続き情報/建物の表示">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="登記の日付">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="順位番号">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="受付年月日">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="受付番号">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="買戻期間">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="付記の日付">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="条件">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="信託原簿番号">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="総代金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="支払済代金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="小作の目的">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="承役地">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="要役地">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="地役権図面番号">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="賠償額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="違約金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="元本利息の支払場所">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="社債の利息">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="延滞損害金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息支払時期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="抹消物件">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="抵当権の目的">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利率">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="追加した物件">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="契約期間">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="元本極度額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="確定債権額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="確定元本債権額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="債権極度額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="債権元本極度額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="物件">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息及び支払時期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="共同目的物件">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="延滞税">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="弁済期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="支払場所">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="優先の定">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息支払期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="延滞税額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="合計債権額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="分割後の債権及び弁済期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息の支払時期">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="根抵当権の目的">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="承役地地役権抹消">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="差押債権">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="清算金の予算額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="根質入債権">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="承継額">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="仮差押債権">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="延滞金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="利息支払方法">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="元利金支払場所">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	<xsl:template match="敷金">
    <xsl:call-template name="General_TAG"/>
  </xsl:template>
	...
	<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
	<xsl:template match="権利者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="義務者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="代理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="所有者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="相続人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="申請人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="所有権登記名義人の表示">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="合併による権利承継者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="所有者の表示">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="代位者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="債務者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="先取特権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="質権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="根質権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="転質権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="抵当権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="根抵当権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="転抵当権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="設定者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="連帯債務者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="受益者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="指定根抵当権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="指定債務者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="被代位者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="登記名義人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="代位申請人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="代位申請人_受益者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="代位申請人_委託者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="共有者及びその持分">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="地上権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="破産管財人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="管財人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="権利承継者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="権利者兼義務者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="債務者兼設定者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="連帯債務者兼設定者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="登記権利者兼登記義務者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="義務者兼申請人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="信託管理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="申立人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="仮登記権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="買戻権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="登記権利者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="受託者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="委託者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="共有者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="債権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="前所有者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="取得者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="永小作権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="債務者の表示">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="賃借権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="転借権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="採石権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="施行者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="登記義務者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="地役権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="転根抵当権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="債務者及び債務金">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="転根質権者">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="管理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="申請人兼義務者代理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="権利者兼代理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="義務者兼代理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="権利者代理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="義務者代理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<xsl:template match="復代理人">
    <xsl:call-template name="Name_TAG"/>
  </xsl:template>
	<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
	<xsl:template match="名義人情報">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT">
						<xsl:if test="not(descendant::被合併会社=null)">
              <xsl:apply-templates select="被合併会社"/>
            </xsl:if>
						<xsl:if test="not(descendant::被合併法人=null)">
              <xsl:apply-templates select="被合併法人"/>
            </xsl:if>
						<xsl:if test="not(descendant::被相続人=null)">
              <xsl:apply-templates select="被相続人"/>
            </xsl:if>
						<!--2014-01-06 CO13-G1-0025 修正-->
						<xsl:if test="not(descendant::被承継者=null)">
              <xsl:apply-templates select="被承継者"/>
            </xsl:if>
						<!--2014-01-06 CO13-G1-0025 EOL-->
						<xsl:if test="not(descendant::分割会社=null)">
              <xsl:apply-templates select="分割会社"/>
            </xsl:if>
						<xsl:if test="not(descendant::分割法人=null)">
              <xsl:apply-templates select="分割法人"/>
            </xsl:if>
						<xsl:if test="not(descendant::住=null)">
              <xsl:apply-templates select="住"/>
            </xsl:if>
						<xsl:if test="not(descendant::持=null)">
              <xsl:apply-templates select="持"/>
            </xsl:if>
						<xsl:if test="not(descendant::氏=null)">
              <xsl:apply-templates select="氏"/>
            </xsl:if>
						<xsl:if test="not(descendant::生=null)">
              <xsl:apply-templates select="生"/>
            </xsl:if>
						<xsl:if test="not(descendant::取=null)">
              <xsl:apply-templates select="取"/>
            </xsl:if>
						<xsl:if test="not(descendant::代=null)">
              <xsl:apply-templates select="代"/>
            </xsl:if>
            			<xsl:if test="not(descendant::電=null)">
              <xsl:apply-templates select="電"/>
            </xsl:if>
						<xsl:if test="not(descendant::会社法人等番号=null)">
              <xsl:apply-templates select="会社法人等番号"/>
            </xsl:if>
						<xsl:if test="not(descendant::識別情報提供区分=null)">
              <xsl:apply-templates select="識別情報提供区分"/>
            </xsl:if>
						<xsl:if test="not(descendant::識別情報未提供理由=null)">
              <xsl:apply-templates select="識別情報未提供理由"/>
            </xsl:if>
						<xsl:if test="not(descendant::識別情報発行区分=null)">
              <xsl:apply-templates select="識別情報発行区分"/>
            </xsl:if>
					</TD>
				</TR>
			</TABLE>
				...
				<xsl:otherwise>
					<xsl:if test="count(./*[(local-name()='資格' or local-name()='代表者氏名' or local-name()='職務執行者等') and .!=''])&gt;0">
						<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
							<TR>
								<TD ALIGN="LEFT">
									<xsl:apply-templates select="資格"/>
                  <xsl:apply-templates select="代表者氏名"/>
                  <xsl:apply-templates select="職務執行者等"/>
								</TD>
							</TR>
						</TABLE>
					</xsl:if>
	...
	<xsl:template match="識別情報提供区分">
		<xsl:if test="not(.='')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" WIDTH="50%">登記識別情報の提供の有無：</TD>
	...
	<xsl:template match="識別情報未提供理由">
		<xsl:if test="../識別情報提供区分='無し'">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" COLSPAN="2" WIDTH="5%">登記識別情報を提供できない理由：</TD>
				</TR>
				<TR>
	...
	<xsl:template match="識別情報発行区分">
		<xsl:if test="not(.='無し')">
			<TABLE ALIGN="CENTER" BORDER="0" WIDTH="100%">
				<TR>
					<TD ALIGN="LEFT" WIDTH="50%">登記識別情報通知希望の有無：</TD>
					<TD ALIGN="LEFT" WIDTH="50%">
            <xsl:apply-templates/>
          </TD>
				</TR>
	...
	<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
	<xsl:template match="変更後の事項">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="更正後の事項">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="追加する事項">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="追加事項">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="根抵当権の表示">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="変更更正後の事項">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="回復すべき登記">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="受益債権">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="被担保債権">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="根質権の表示">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="回復する登記">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="回復する登記事項">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="仮登記根抵当権の表示">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="保全仮登記">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<xsl:template match="変更の内容">
    <xsl:call-template name="Matter_TAG"/>
  </xsl:template>
	<!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
